...
using proctoring.identity.server.STS.Identity.ViewModels.Consent;
using proctoring.identity.server.STS.Identity.ViewModels.Device;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace proctoring.identity.server.STS.Identity.Controllers
{
    [Authorize]
    [SecurityHeaders]
