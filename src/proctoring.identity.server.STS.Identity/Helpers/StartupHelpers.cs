...
using proctoring.identity.server.STS.Identity.Configuration.ApplicationParts;
using proctoring.identity.server.STS.Identity.Configuration.Constants;
...
using proctoring.identity.server.STS.Identity.Services;
